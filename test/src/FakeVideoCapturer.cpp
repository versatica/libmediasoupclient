...
namespace cricket
{
FakeVideoCapturer::FakeVideoCapturer(bool is_screencast) // NOLINT(readability-identifier-naming)
  : running_(false), is_screencast_(is_screencast), rotation_(webrtc::kVideoRotation_0)
{
...
void FakeVideoCapturer::ResetSupportedFormats(const std::vector<cricket::VideoFormat>& formats)
{
...
cricket::CaptureState FakeVideoCapturer::Start(const cricket::VideoFormat& format)
{
	running_ = true;
